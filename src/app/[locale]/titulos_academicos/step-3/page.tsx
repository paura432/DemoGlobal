          ...
          <div className="flex gap-2 items-center">
            {PASOS.map((_, i) => (
              <div key={i} className="flex items-center">
                <div
                  className={`w-6 h-6 rounded-full text-xs font-bold flex items-center justify-center border ${i === 2
        ...
        <div className="w-full max-w-[1100px] px-4 sm:px-10 mt-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start min-h-[300px]">
            <div className="min-h-[280px] mt-2">
              <h2 className="text-2xl font-semibold text-[#414B61] mb-4" dangerouslySetInnerHTML={{ __html: block.titulo }} />
                  ...
                  <div className="w-[180px] md:w-[220px] lg:w-[260px] mx-auto grid place-items-center">
                    ...
                    {issuedWrapQr ? (
                      <div className="flex flex-col items-center">
                        ...
                        {issuing && <span className="mt-1 text-xs text-[#414B61]">{UI[locale].generating}</span>}
                      </div>
                    ) : (
                      <span className="text-[#414B61] text-sm">{issuing ? UI[locale].generating : UI[locale].preparing}</span>
                    )}
                  </div>
                </div>
              )}
