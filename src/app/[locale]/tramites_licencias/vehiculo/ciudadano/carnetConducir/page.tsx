...
export default function CarnetPage() {
  ...
  const [t, setT] = useState<CarnetTranslations | null>(null);
  ...
  useEffect(() => {
    (async () => {
      const res = await fetch(`/locales/tramites_licencias/vehiculo/ciudadano/carnetConducir/${locale}.json`);
      const json = await res.json();
      setT(json);
    })();
  }, [locale]);

  // 🔹 Emitir credencial y generar QR
  ...
  const handleScanComplete = () => {
    localStorage.setItem('carnetCompleted', 'true');
