          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start min-h-[300px]">
            <div className="min-h-[280px] mt-2">
              ...
              <h2 className="text-2xl font-semibold text-[#414B61] mb-2">
                {t.conoceLabel}{' '}
                <span className="text-[#0066FF]">{currentProfile.nombre}</span>
              </h2>
              <p className="text-sm text-[#414B61] leading-relaxed max-w-[95%]">
                {currentProfile.descripcion}
              </p>
              {selected === 'policia' && (
                <h2 className="text-sm text-[#414B61] leading-relaxed max-w-[95%] mt-4">
                  {locale === 'es'
